...
namespace Travelitinerary.Server.Migrations
{
    ...
    [Migration("20240206055303_updateValidation")]
            ...
            modelBuilder.Entity("Travelitinerary.Shared.Domain.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Kevin",
                            Price = 56f,
                            TimeEnd = new DateTime(2024, 2, 6, 19, 53, 3, 734, DateTimeKind.Local).AddTicks(6751),
                            TimeStart = new DateTime(2024, 2, 6, 13, 53, 3, 734, DateTimeKind.Local).AddTicks(6737),
                            Type = "Cleaning",
                            UpdatedBy = "Arthur"
                        });
                });
